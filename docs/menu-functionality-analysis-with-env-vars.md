...
- `DATABRICKS_SERVER_HOSTNAME`: Databricks 워크스페이스 호스트
...
- `DATABRICKS_TOKEN`: Databricks 액세스 토큰
- `DATABRICKS_HTTP_PATH`: SQL 웨어하우스 HTTP 경로
- `AZURE_OPENAI_PTU_ENDPOINT`: Azure OpenAI PTU 엔드포인트
- `AZURE_OPENAI_PTU_KEY`: Azure OpenAI PTU API 키
- `AZURE_OPENAI_PTU_DEPLOYMENT`: OpenAI 배포 이름
- `AZURE_OPENAI_PTU_API_VERSION`: OpenAI API 버전 (기본값: 2024-10-21)
...
- `AZURE_OPENAI_PTU_KEY`: Azure OpenAI PTU API 키
- `AZURE_OPENAI_PTU_DEPLOYMENT`: OpenAI 배포 이름
- `AZURE_OPENAI_PTU_API_VERSION`: OpenAI API 버전
...
- `AZURE_SEARCH_KEY`: Azure AI Search API 키
- `AZURE_SEARCH_INDEX_NAME`: 검색 인덱스 이름
- `AZURE_OPENAI_PTU_ENDPOINT`: Azure OpenAI PTU 엔드포인트
- `AZURE_OPENAI_PTU_KEY`: Azure OpenAI PTU API 키
- `AZURE_OPENAI_PTU_DEPLOYMENT`: OpenAI 배포 이름
- `AZURE_OPENAI_PTU_API_VERSION`: OpenAI API 버전
- `AZURE_OPENAI_EMBEDDING_ENDPOINT`: Azure OpenAI Embedding 엔드포인트
- `AZURE_OPENAI_EMBEDDING_KEY`: Azure OpenAI Embedding API 키
- `AZURE_OPENAI_EMBEDDING_DEPLOYMENT`: Embedding 배포 이름
- `AZURE_OPENAI_EMBEDDING_API_VERSION`: Embedding API 버전
...
- `DATABRICKS_TOKEN`: Databricks 액세스 토큰
- `DATABRICKS_HTTP_PATH`: SQL 웨어하우스 HTTP 경로
- `AZURE_COSMOS_ENDPOINT`: CosmosDB 엔드포인트
- `AZURE_COSMOS_KEY`: CosmosDB 키
- `AZURE_COSMOS_DATABASE_ID`: CosmosDB 데이터베이스 ID
- `AZURE_SEARCH_ENDPOINT`: Azure AI Search 엔드포인트
- `AZURE_SEARCH_KEY`: Azure AI Search API 키
- `AZURE_SEARCH_INDEX_NAME`: 검색 인덱스 이름
- `AZURE_OPENAI_PTU_ENDPOINT`: Azure OpenAI PTU 엔드포인트
...
- `AZURE_OPENAI_PTU_DEPLOYMENT`: OpenAI 배포 이름
- `AZURE_OPENAI_PTU_API_VERSION`: OpenAI API 버전
- `OPENAI_API_KEY`: Standard OpenAI API 키 (Fallback)
...
**API 엔드포인트**:
- `GET /api/etf-guide` - ETF 가이드 데이터
- `GET /api/etf-admin/bot-config` - ETF 봇 설정
...
#### PostgreSQL
- `DATABASE_URL`: PostgreSQL 연결 문자열 (표준 형식 사용)
...
- `AZURE_POSTGRES_SSL`: SSL 연결 사용 여부 (true/false)

#### Databricks
- `DATABRICKS_SERVER_HOSTNAME`: Databricks 워크스페이스 호스트 (필수)
- `DATABRICKS_HTTP_PATH`: SQL 웨어하우스 HTTP 경로 (필수)
- `DATABRICKS_TOKEN`: Databricks 액세스 토큰 (필수)
...
**Private Endpoint**:
- `AZURE_DATABRICKS_USE_PRIVATE_ENDPOINT`: Private Endpoint 사용 여부 (true/false)
- `AZURE_DATABRICKS_PRIVATE_ENDPOINT_URL`: Private Endpoint URL

#### Azure OpenAI PTU (Provisioned Throughput Unit)
- `AZURE_OPENAI_PTU_ENDPOINT`: Azure OpenAI PTU 엔드포인트 (필수)
- `AZURE_OPENAI_PTU_KEY`: Azure OpenAI PTU API 키 (필수)
- `AZURE_OPENAI_PTU_DEPLOYMENT`: OpenAI 배포 이름 (기본값: gpt-4)
- `AZURE_OPENAI_PTU_MODEL`: 모델 이름 (기본값: gpt-4.1)
- `AZURE_OPENAI_PTU_API_VERSION`: API 버전 (기본값: 2024-10-21)

**Fallback: Standard OpenAI**
- `OPENAI_API_KEY`: Standard OpenAI API 키 (Azure 미설정 시 사용)

**Private Endpoint**:
- `AZURE_OPENAI_PTU_USE_PRIVATE_ENDPOINT`: Private Endpoint 사용 여부 (true/false)
- `AZURE_OPENAI_PTU_PRIVATE_ENDPOINT_URL`: Private Endpoint URL

#### Azure OpenAI Embedding
- `AZURE_OPENAI_EMBEDDING_ENDPOINT`: Azure OpenAI Embedding 엔드포인트 (필수)
- `AZURE_OPENAI_EMBEDDING_KEY`: Azure OpenAI Embedding API 키 (필수)
- `AZURE_OPENAI_EMBEDDING_DEPLOYMENT`: Embedding 배포 이름 (기본값: text-embedding-ada-002)
- `AZURE_OPENAI_EMBEDDING_MODEL`: Embedding 모델 이름 (기본값: text-embedding-3-large)
- `AZURE_OPENAI_EMBEDDING_API_VERSION`: Embedding API 버전 (기본값: 2024-10-21)

**Private Endpoint**:
- `AZURE_OPENAI_EMBEDDING_USE_PRIVATE_ENDPOINT`: Private Endpoint 사용 여부 (true/false)
- `AZURE_OPENAI_EMBEDDING_PRIVATE_ENDPOINT_URL`: Private Endpoint URL

#### Azure AI Search
- `AZURE_SEARCH_ENDPOINT`: Azure AI Search 엔드포인트 (필수)
- `AZURE_SEARCH_KEY`: Azure AI Search API 키 (필수)
- `AZURE_SEARCH_INDEX_NAME`: 검색 인덱스 이름 (기본값: nh-financial-index)

**대체 변수명**:
- `AZURE_SEARCH_API_KEY` → `AZURE_SEARCH_KEY`

**Private Endpoint**:
- `AZURE_SEARCH_USE_PRIVATE_ENDPOINT`: Private Endpoint 사용 여부 (true/false)
- `AZURE_SEARCH_PRIVATE_ENDPOINT_URL`: Private Endpoint URL

#### CosmosDB
- `AZURE_COSMOS_ENDPOINT`: CosmosDB 엔드포인트 (필수)
- `AZURE_COSMOS_KEY`: CosmosDB 키 (필수)
- `AZURE_COSMOS_DATABASE_ID`: CosmosDB 데이터베이스 ID (기본값: nh-investment)

**대체 변수명**:
- `COSMOSDB_ENDPOINT` → `AZURE_COSMOS_ENDPOINT`
- `COSMOSDB_KEY` → `AZURE_COSMOS_KEY`
- `COSMOSDB_DATABASE_NAME` → `AZURE_COSMOS_DATABASE_ID`
...
- **환경변수**: `DATABASE_URL`, `DATABRICKS_SERVER_HOSTNAME`, `DATABRICKS_HTTP_PATH`, `DATABRICKS_TOKEN`, `AZURE_OPENAI_PTU_*`

### JSON 프롬프트 실행 엔진
- **파일**: `server/services/json-prompt-execution-engine.ts`
- **기능**: JSON 스키마 검증, 변수 해석, OpenAI 호출
- **데이터소스**: PostgreSQL (프롬프트 정의), OpenAI (실행)
- **환경변수**: `DATABASE_URL`, `AZURE_OPENAI_PTU_*`
...
- **환경변수**: `DATABASE_URL`, `DATABRICKS_SERVER_HOSTNAME`, `DATABRICKS_HTTP_PATH`, `DATABRICKS_TOKEN`
...
- **환경변수**: `DATABASE_URL`, `AZURE_SEARCH_ENDPOINT`, `AZURE_SEARCH_KEY`, `AZURE_OPENAI_EMBEDDING_*`, `AZURE_OPENAI_PTU_*`
...
환경변수는 각 서비스별로 체계적으로 관리되며, Azure App Service Application Settings를 통해 설정됩니다. 모든 환경변수는 `server/services/azure-config.ts`의 `AzureConfigService`를 통해 중앙 집중식으로 관리되며, 설정 확인 시 자동으로 Activity Logger에 기록됩니다.

**최신 변경사항 (2025-01 기준)**:
- Databricks 환경변수: `DATABRICKS_SERVER_HOSTNAME` 사용 (표준 명명 규칙 준수)
- Azure OpenAI 환경변수: `AZURE_OPENAI_PTU_*` 형식 사용 (PTU 및 Embedding 분리)
- Azure AI Search 환경변수: `AZURE_SEARCH_KEY` 사용 (API_KEY → KEY로 변경)
- CosmosDB 환경변수: `AZURE_COSMOS_DATABASE_ID` 사용
- Private Endpoint 지원 추가
